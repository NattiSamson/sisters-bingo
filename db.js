...
async rejectWithdrawal(
  ...
  try {
    ...
    /*
     * If your status column is BOOLEAN DEFAULT false:
     *
     * false = pending
     * true  = processed
     *
     * We also check is_approved.
     */
    if (withdrawal.status === true) {
      await client.query("ROLLBACK");
    ...
    // --------------------------------------------------------
    // 6. Return information to bot.js
    // --------------------------------------------------------
    return {
      success: true,
